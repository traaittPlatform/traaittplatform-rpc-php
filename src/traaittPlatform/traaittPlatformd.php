...
namespace traaittPlatform;

use traaittPlatform\Http\JsonResponse;
use traaittPlatform\Http\RpcClient;

/**
 * Wrapper for traaittPlatform's traaittPlatformd JSON-RPC interface.
 * @package traaittPlatform
 */
class traaittPlatformd extends RpcClient
{
    /** @var int */
    protected $rpcPort = 23896;
     ...
     * @param string $address     Valid traaittPlatform wallet address. Required.
     * @return JsonResponse
     */
