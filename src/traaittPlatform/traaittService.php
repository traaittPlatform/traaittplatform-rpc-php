...
/**
 * Class traaittService
 * Wrapper for traaittPlatform's turtle-service (formerly walletd) JSON-RPC interface.
 * @package traaittPlatform
 */
class traaittService extends RpcClient
{
    /** @var int */
    protected $rpcPort = 8337;
